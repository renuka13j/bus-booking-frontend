  ...
  return (
    <div className="min-h-screen bg-navy-950">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 pt-12 sm:pt-16 pb-10 text-center animate-fade-in">
          <p className="text-gold-500 uppercase tracking-[0.2em] text-xs font-semibold mb-3">
            Book with confidence
          </p>
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-semibold text-cream mb-3 px-2">
      ...
      <div className="flex justify-center px-4 -mt-4 relative z-10">
        <div
          className="bg-navy-800 rounded-2xl shadow-2xl shadow-black/40 border border-navy-700 w-full max-w-md overflow-visible animate-fade-in"
      ...
      {/* Trust badges */}
      <div className="max-w-3xl mx-auto px-4 py-10 sm:py-16 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6">        {[
        ...
        <div key={i} className="text-center">
          <div className="bg-navy-800 border border-navy-700 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 transition-transform hover:scale-110 hover:border-gold-500/50">
