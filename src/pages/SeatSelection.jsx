  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 sm:py-10 flex-1 w-full">
          <BookingStepper currentStep={selectedSeats.length > 0 ? 3 : 2} />

          <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-6 animate-fade-in">
            <div>
              ...
              <div className="bg-navy-800/90 backdrop-blur-sm border border-navy-700 rounded-xl p-4 sm:p-6">
              ...
              {selectedSeats.length > 0 && (
                <div className="mt-6 flex flex-col gap-4 animate-fade-in">
                  ...
                  {selectedSeats.map((seatNumber) => (
                    <div
                      key={seatNumber}
                      className="bg-navy-800/90 backdrop-blur-sm border border-navy-700 rounded-lg p-4 flex flex-col sm:flex-row gap-3 sm:items-center"
                    >
            ...
            <div className="bg-navy-800/90 backdrop-blur-sm border border-navy-700 rounded-xl p-6 h-fit md:sticky md:top-20">
